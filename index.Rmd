...
Ahora, podemos quedarnos con algunas columnas:
```{r}
censo2007_sub=censo2007[,-c(1,5,6,9)] # eliminando
# queda
str(censo2007_sub)
```
Este último data frame está en formato **long**, pasémoslo a formato **wide**:
...
Los nombres de columnas son muy largos, podemos reducirlos así:
...
La interpretación de la Tabla \@ref(tab:rp1rp2) NO es tan directa como lo era en la regresión lineal. Sin hacer ningún cálculo, aquí podemos ver:
...
sdVIs=apply(censo2007_wide_Totales[,c("conSeguro_Total","indep_Total")],2,sd)
